...
HiChat.prototype = {
    init: function() {
        ...
        this.socket.on('loginSuccess', function() {
            document.title = '在线聊天室 | ' + document.getElementById('nicknameInput').value;
...
"</button>";
			var user="<button type='button' class='btn btn-default btn-xs'>"+
  "<span class='glyphicon glyphicon-user'></span>User"+
"</button>";
            document.getElementById('status').innerHTML = (userCount > 1 ?  users :  user) +'目前有 <span class="badge">'+userCount + '</span>人在线';
        });
